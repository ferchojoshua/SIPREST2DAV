...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2025 at 03:33 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_LISTAR_RUTAS` (IN `p_sucursal_id` INT)   BEGIN
    ...
    GROUP BY r.ruta_id, r.ruta_nombre, r.ruta_descripcion, r.ruta_codigo, r.ruta_color, 
             ...
             uc.nombre_usuario, uc.apellido_usuario
...
(4, NULL, 'Apertura de Caja', 90000, NULL, NULL, '2025-07-07', NULL, NULL, NULL, 'VIGENTE', '23:10:54', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, 'NORMAL');
