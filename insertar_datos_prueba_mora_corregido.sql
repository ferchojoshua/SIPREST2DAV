-- ====================================================
-- INSERTAR DATOS DE PRUEBA PARA SISTEMA DE MORA - CORREGIDO
-- ====================================================

-- Insertar clientes de prueba (sin cliente_apellidos)
INSERT INTO clientes (cliente_nombres, cliente_nro_documento, cliente_celular, cliente_email, cliente_direccion, cliente_estatus, cliente_fecha_registro) VALUES
